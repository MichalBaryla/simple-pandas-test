...
try:
    ...
    print("test_when_extra_spaces_in_rules passed.")
except Exception as e:
    print(f"An error occurred: {e}")
try:
    test_empty_result_when_invalid_rules()
    print("test_empty_result_when_invalid_rules passed.")
except Exception as e:
    print(f"An error occurred: {e}")
try:
    test_empty_result_when_invalid_labels()
    print("test_empty_result_when_invalid_labels passed.")
except Exception as e:
    print(f"An error occurred: {e}")
try:
    test_subtraction_of_two_columns()
    print("test_subtraction_of_two_columns passed.")
except Exception as e:
    print(f"An error occurred: {e}")
try:
    test_sum_of_two_columns()
    print("test_sum_of_two_columns passed.")
except Exception as e:
    print(f"An error occurred: {e}")
try:
    test_multiplication_of_two_columns()
    print("test_multiplication_of_two_columns passed.")
except Exception as e:
    print(f"An error occurred: {e}")